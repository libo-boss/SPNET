...
def FeatureNet(reuse=False):  # add  FeatureNet
    ...
    trans1 = Conv2D(filters=56, kernel_size=(5, 5), strides=2,padding='same',name='trans1')(merge_layers)
    bnt1 = BatchNormalization()(trans1)
    actt1 = Activation('relu')(bnt1)
    print('actt1.shape',actt1.shape)
    view = Reshape((1,14,14,14))( actt1)
    ...
    g6=Conv3DTranspose(filters=64, kernel_size=(3, 3,3), padding='same',strides=(2, 2, 2),name='g6')(actg5)
    ...
    print('actg5.shape:',actg5.shape,'g10.shape:',g6.shape)
