...
def FeatureNetwork():
    ...
    bn2 = BatchNormalization()(merge_layers1)   
    ...
    bn4= BatchNormalization()(merge_layers3)   
    ...
    bn6= BatchNormalization()(merge_layers5)   
...
def FeatureNet(reuse=False):  # add  FeatureNet
    ...
    inf = Input(shape = (9,), name='F_Input')
    print('merge_layers.shape',merge_layers.shape)
    print('merge_layers.shape',merge_layers[0,0,0,759:768].shape)
    merge_layers[0,0,0,759:768]==inf
    ...
    view1 = Reshape((1,28,28,28))( actt1)
    
    trans2 = Conv2D(filters=56, kernel_size=(5, 5), strides=2,padding='same',name='tr2')(merge_layers)
    bnt2 = BatchNormalization()(trans2)
    actt2 = Activation('relu')(bnt2)
    print('actt1.shape',actt1.shape)
    view2 = Reshape((1,14,14,14))( actt2)
    trs1=Conv3DTranspose(filters=28, kernel_size=(3, 3,3),padding='same', strides=(2, 2,2),name='tr1')(view2)
    print('trs1:',trs1.shape)
    mer=concatenate([view1, trs1],axis=1) 
    trans2 = Conv3DTranspose(filters=512, kernel_size=(5, 5,5), strides=(2, 2, 2),padding='same',name='trans2')(mer)
    bnt2 = BatchNormalization()(trans2)
    actt2 = Activation('relu')(bnt2)
    
    ###Generation network
    g1=Conv3DTranspose(filters=450, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g1')(actt2)
    bng1 = BatchNormalization()(g1)
    actg1 = Activation('relu')(bng1)
    
    g2=Conv3DTranspose(filters=400, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g2')(actg1)
    bng2 = BatchNormalization()(g2)
    actg2 = Activation('relu')(bng2)
   
    g3=Conv3DTranspose(filters=350, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g3')(actg2)
    bng3 = BatchNormalization()(g3)
    actg3 = Activation('relu')(bng3)
   
    g4=Conv3DTranspose(filters=300, kernel_size=(3, 3,3), strides=(1, 1, 1),name='g4')(actg3)
    bng4 = BatchNormalization()(g4)
    actg4 = Activation('relu')(bng4)
   
    g5=Conv3DTranspose(filters=256, kernel_size=(3, 3,3), strides=(1, 1, 1),name='g5')(actg4)
    bng5 = BatchNormalization()(g5)
    actg5 = Activation('relu')(bng5)
   
    g6=Conv3DTranspose(filters=200, kernel_size=(3, 3,3), strides=(1, 1, 1),name='g6')(actg5)
    ...
    print('actg8.shape:',actg8.shape,'g9.shape:',g9.shape)
    model = Model(inputs=[inp1, inp2,inf], outputs=g9)
    return model
