...
def model1():
    ...
    cnn1 = Conv2D(filters=128, kernel_size=(4, 4), strides=2,padding='same')(inp1)
    bn1 = BatchNormalization()(cnn1)
    act1 = Activation('relu')(bn1)
    ...
    model1=Model(inputs=inp1, outputs=act6)
    return model1

def model2():
    inp1 = Input(shape=(128,128, 1), name='F_ImageInput1')  # 创建输入1
    inp2 = Input(shape=(128,128, 1), name='F_ImageInput2')
    cnn1 = Conv2D(filters=128, kernel_size=(4, 4), strides=2,padding='same')(inp2)
    bn1 = BatchNormalization()(cnn1)
    act1 = Activation('relu')(bn1)
    ...
    model2=Model(inputs=inp2, outputs=act6)
    return model2
def FeatureNet(reuse=False):  # add  FeatureNet
    
    input1 = model1()                     # 孪生网络中的一个特征提取
    input2 = model2()                     # 孪生网络中的另一个特征提取
    ...
    print('merge_layers:',merge_layers.shape)
    ...
    view = Reshape((6,32,32,32))( merge_layers)
    # # print('view.shape',view.shape)
    
    trans2 = Conv3DTranspose(filters=256, kernel_size=(5, 5,5), strides=(2, 2, 2),padding='same',name='trans2')(view)
    bnt2 = BatchNormalization()(trans2)
    actt2 = Activation('relu')(bnt2)
    
    ###Generation network
    g1=Conv3DTranspose(filters=256, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g1')(actt2)
    ...
    g4=Conv3DTranspose(filters=128, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g4')(actg3)
    bng4 = BatchNormalization()(g4)
    actg4 = Activation('relu')(bng4)
   
    g5=Conv3DTranspose(filters=100, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g5')(actg4)
    bng5 = BatchNormalization()(g5)
    actg5 = Activation('sigmoid')(bng5)
   
    g6=Conv3DTranspose(filters=64, kernel_size=(3, 3,3),padding='same', strides=(1, 1, 1),name='g6')(actg5)
    ...
    print('actg5.shape:',actg5.shape,'g6.shape:',g6.shape)
