...
def FeatureNet(reuse=False):  # add  FeatureNet
    ...
    trans2 = Conv3DTranspose(filters=256, kernel_size=(5, 5,5), strides=(2, 2, 2),padding='same',name='trans2')(mer)
    bnt2 = BatchNormalization()(trans2)
    actt2 = Activation('relu')(bnt2)
    ...
    g3=Conv3DTranspose(filters=150, kernel_size=(3, 3,3),padding='valid', strides=(1, 1, 1),name='g3')(actg2)
