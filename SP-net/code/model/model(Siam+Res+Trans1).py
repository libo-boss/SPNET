...
###Generation network
    ...
    g4=Conv3DTranspose(filters=128, kernel_size=(3, 3,3),padding='valid', strides=(1, 1, 1),name='g4')(actg3)
    bng4 = BatchNormalization()(g4)
    actg4 = Activation('relu')(bng4)
    
    g5=Conv3DTranspose(filters=100, kernel_size=(3, 3,3),padding='valid', strides=(1, 1, 1),name='g5')(actg4)
    bng5 = BatchNormalization()(g5)
    actg5 = Activation('sigmoid')(bng5)
    
    g6=Conv3DTranspose(filters=64, kernel_size=(3, 3,3),padding='valid', strides=(1, 1, 1),name='g6')(actg5)
